...
namespace MetricDashboard.Extensions
{
    ...
    {
        public static DateTime GetDateTime(this TimeScopeEnum timeScope, int customScopeLength = 14)
        {
            ...
            switch (timeScope)
            {
                ...
                case TimeScopeEnum.CUSTOM_SCOPE:
                    return now.AddDays(-customScopeLength);
                default:
                    return now;
            }
        }
