...
{
    public class ChangeFailureCalculatorTests
    {
        [Fact]
        public async Task Calculate_Should_Add_MetricResult_To_Database()
        {
            ...
            // Arrange
            var loggerMock = new Mock<ILogger<ChangeFailureCalculator>>();
            ...
            var calculator = new ChangeFailureCalculator(loggerMock.Object,bitbucketServiceMock.Object, dbFactory,jiraServiceMock.Object);
            ...
            {
                var metricEnum = MetricEnum.CHANGE_FAILURE_RATE;
                ...
                Assert.Equal(50, metricResults.First().Score,2);
            }
        }
    }
}
