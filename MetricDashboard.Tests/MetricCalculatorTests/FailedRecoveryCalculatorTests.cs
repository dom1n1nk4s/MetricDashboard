...
{
    public class FailedRecoveryCalculatorTests
    {
        [Fact]
        public async Task Calculate_Should_Add_MetricResult_To_Database()
        {
            ...
            // Arrange
            var loggerMock = new Mock<ILogger<FailedRecoveryCalculator>>();
            ...
            var calculator = new FailedRecoveryCalculator(loggerMock.Object, bitbucketServiceMock.Object, dbFactory, jiraServiceMock.Object);
            ...
            {
                var metricEnum = MetricEnum.FAILED_DEPLOYMENT_RECOVERY_TIME;
                ...
                Assert.Equal(90, metricResults.First().Score, 2);
            }
        }
    }
}
